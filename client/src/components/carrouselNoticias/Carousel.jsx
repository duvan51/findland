...
const Carousel = () => {
  ...
  return (
    <div className="slider w-full h-[30rem] bg-gray-400">
      ...
      <div className="slider-content w-full h-full">
        {data?.map((slide, index) => (
          <div
            key={slide.url}
            className={`w-full slide ${index === currentIndex ? 'active' : ''}`}
            ...
            <div className="caption px-20 flex w-full h-full">
                ...
                <div className='w-1/2 flex flex-col gap-5 justify-center'>
                    ...
                    <div className='flex gap-3 h-10 py-10' >
                        <div className='h-full text-sm flex items-center'> Leer Mas </div>
                        <div className='h-full text-3xl flex items-center'> <FaArrowRightLong />  </div>
                    </div>
